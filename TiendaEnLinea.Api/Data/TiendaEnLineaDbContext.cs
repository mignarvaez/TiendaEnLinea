...
namespace TiendaEnLinea.Api.Data
{
	/// <summary>
	/// Clase que representa el dbcontext que interactua con la base de datos
	/// Las migraciones se pueden crear usando los siguientes comandos:
	/// dotnet ef migrations add InitialCreate (.NET Core CLI)
	/// o
	/// Add-Migration InitialCreate (Visual Studio (Powershell))
	/// Para correr la migración: dotnet ef database update o update-database
	/// Se puede deshacer una migración usando update-database 0 y borrar la migracion asociada posteriormente con remove-migration 
	/// </summary>
	public class TiendaEnLineaDbContext:DbContext
    {   
        // El constructor tiene un dbcontextoptions de tipo tiendaenlineadbcontext
        // Con base options se pasa las options de este clase a la clase base de la que hereda(DbContext)
        public TiendaEnLineaDbContext(DbContextOptions<TiendaEnLineaDbContext> options):base(options)
        {
        }

        /// <summary>
        /// El enfoque de esta solucion es crear el carrito de compras por lo que se hara un seed con datos ya preparados
        /// sobrescribiendo el método OnModelCreating
        /// </summary>
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
			...
			//Productos que se agregaran por defecto al sistema
			//Beauty Category
		...
		// Propiedades de tipo dbset asociadas a cada entidad, necesarias para generar las tablas 
